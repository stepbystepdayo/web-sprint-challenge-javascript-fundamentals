...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//The nested function can see the variables outside of its scope, which is called closure. Because of closure, the nestedFunction can see the variable internal, and print it out. 
...
const zooAnimals = [
  ...
  */
  ...
  // console.log('this is Request1:',animalNames(zooAnimals));
  ...
  */
  ...
  // console.log('this is Rquest2:',lowerCaseNames(zooAnimals));
  ...
  */
  ...
  // console.log('this is Request3:',lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(data){
    const totalPop = data.reduce((total,item)=>{
      return total += item.population;
    },0);
    return totalPop;
  }
  
  // console.log('this is Request4:',USApop(zooAnimals));
